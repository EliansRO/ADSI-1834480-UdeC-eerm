  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="students_eerm.php">
          <i class="fa fa-check-square" aria-hidden="true"></i>
          <span>Inicio</span></a>
      </li>

       <li class="nav-item">
        <a class="nav-link" href="form_eerm.php">
          <i class="fa fa-check-square" aria-hidden="true"></i>
      ...
      <div class="text-center info d-none d-md-inline">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="logout_eerm_2.php">Cerrar Session</a>
        </div>
      </div>
    </div>
  </div>
