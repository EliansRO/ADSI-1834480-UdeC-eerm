...
$bd = new PDO(
    $dsn = "mysql:host=localhost;dbname=".$bd,$user,$pass,
    array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8")
);

$sentencia = $bd->prepare("DELETE FROM students_eerm WHERE id='$id'");
$resultado = $sentencia->execute([$id]);

if($resultado === TRUE){
    echo "<div class='alert alert-danger'>Datos Del Estudiante Eliminados Correctamente</div>";
  }else{
    echo "<div class='alert alert-warning'>Error Al Borrar Los Datos Del Estudiante</div>";
  }
