...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index_eerm.php">
          <i class="fa fa-home" aria-hidden="true"></i>
          <span>Inicio</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="edit_eerm.php">
...
<?php
    ...
    $programaf        = $_REQUEST['programaf'];
    $tipoie           = $_REQUEST['tipoie'];
    $tiempogb         = $_REQUEST['tiempogb'];
    $nivelep          = $_REQUEST['nivelep'];
    $actividadep      = $_REQUEST['actividadep'];
    $tipovi           = $_REQUEST['tipovi'];
    $nivelih          = $_REQUEST['nivelih'];
    $calificacionpm   = $_REQUEST['calificacionpm'];
...
$sentencia = $bd->prepare("UPDATE students_eerm SET nombre = ?, apellido = ?, tipo_doc = ?, num_doc = ?, direccion = ?, celular = ?, fecha_nacimiento = ?, genero = ?, zona = ?, estadoc = ?, programaf = ?, tipoie = ?, tiempogb = ?, nivelep = ?, actividadep = ?, tipovi = ?, nivelih = ?, calificacionpm = ?, email = ?, password = ?  WHERE id = ?;");
$resultado = $sentencia->execute([$nombre,$apellido,$tipo_doc,$num_doc,$direccion,$celular,$fecha_nacimiento,$genero,$zona,$estadoc,$programaf,$tipoie,$tiempogb,$nivelep,$actividadep,$tipovi,$nivelih,$calificacionpm,$email,$password,$id]);
