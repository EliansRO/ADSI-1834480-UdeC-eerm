            ...
            <div class="row" style="background: yellow">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="validate_eerm.php" method="POST">
                    <div class="form-group">
                      <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Correo Electronico" required="email">
                    </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="register_eerm.php">Crea una cuenta!</a>
                  </div>
                </div>
              </div>
            </div>
