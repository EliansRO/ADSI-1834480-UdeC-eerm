...
$sentencia = $bd->prepare("INSERT INTO students_eerm(nombre,apellido,num_doc,programaf,email,password,genero,tipo_usuario) VALUES (?,?,?,?,?,?,?,?);");
    $resultado = $sentencia->execute([$nombre,$apellido,$num_doc,$programaf,$email,$password,$genero,$tipo_usuario]);

if($resultado === TRUE){
    echo "<div class='alert alert-primary'>Datos Del Estudiante Registrados Correctamente</div>";
  }else{
    echo "<div class='alert alert-warning'>Error Al Registrar Los Datos Del Estudiante</div>";
  }
      ...
      <footer class="sticky-footer bg-info">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <label>Proyecto Creado Por: Elians Enrique Rocha Muñoz</label><br>
            <label>Para mayor informacion llame al numero 300-797-6437</label><br>
